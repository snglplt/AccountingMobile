...
class AlisEvrakActivity : AppCompatActivity() {
    lateinit var username: String
    lateinit var uid: String
    lateinit var ivBack: ImageView
    lateinit var edTarih1: EditText
    lateinit var edTarih2: EditText
    lateinit var recyler_alis_evrak_listesi: RecyclerView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_alis_evrak)
        onBaslat()

        overridePendingTransition(R.anim.anim_slide_in_right, R.anim.anim_slide_in_left)
        ivBack.setOnClickListener(View.OnClickListener { finish() })
        progressBar = findViewById(R.id.progressBar)
        Toast.makeText(this, getString(R.string.alisevraklarilisteleniyor), Toast.LENGTH_LONG)
            .show()
        ...
        btnGoster.setOnClickListener { alisEvrakTarihGetir() }
    }
    ...
    private fun alisEvrakTarihGetir() {
        startLoadingAnimation()
        Toast.makeText(this, getString(R.string.secilentariharaligialislistesi), Toast.LENGTH_LONG)
            .show()
        ...
        var url = Consts.AlisEvrakListesi + urlek
        ...
        Log.d("alis_evrak_listesi_tarih", url)
        val request = JsonObjectRequest(
            ...
            { response ->
                ...
                recyler_alis_evrak_listesi.layoutManager = LinearLayoutManager(this)
                recyler_alis_evrak_listesi.setHasFixedSize(false)
                ...
                Toast.makeText(
                    this,
                    getString(R.string.alisevraklistesibulunmuyor),
                    Toast.LENGTH_LONG
                ).show()
    ...
    private fun getUserData(context: Context) {
        ...
        recyler_alis_evrak_listesi.adapter = evrakGetirAdapter(newArrayList)
    ...
    private fun onBaslat() {
        ...
        recyler_alis_evrak_listesi = findViewById(R.id.recyler_alis_evrak_listesi)
