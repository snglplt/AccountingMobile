...
class BugunYapilacakOdemelerActivity : AppCompatActivity() {
    lateinit var recyler_bugun_yapilan_odeme_listesi: RecyclerView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_bugun_yapilacak_odemeler)
        onBaslat()
        overridePendingTransition(R.anim.anim_slide_in_right, R.anim.anim_slide_in_left)
        ivBack.setOnClickListener(View.OnClickListener { finish() })
        Toast.makeText(this,getString(R.string.bugunyapilanodemelerlisteleniyor), Toast.LENGTH_LONG).show()
    ...
    private fun onBaslat() {
        recyler_bugun_yapilan_odeme_listesi=findViewById(R.id.recyler_bugun_yapilan_odeme_listesi)
    ...
    private fun onTahsilatGetir() {
        ...
        Log.d("bugun_yapilacak_odeme_listesi", url)
        val request = JsonObjectRequest(
            ...
            { response ->
                try {
                    ...
                    Toast.makeText(this,getString(R.string.bugunyapilanodemebulunmamakta), Toast.LENGTH_LONG).show()
                    val alert= Alert()
                    alert.showAlert(this,getString(R.string.uyari),getString(R.string.bugunyapilanodemebulunmamakta))

                }
                recyler_bugun_yapilan_odeme_listesi.layoutManager = LinearLayoutManager(this)
                recyler_bugun_yapilan_odeme_listesi.setHasFixedSize(false)
    ...
    private fun getUserData(context: Context) {
        ...
        recyler_bugun_yapilan_odeme_listesi.adapter = oncekiOnarimGetirAdapter(newArrayList)
