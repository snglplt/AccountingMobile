...
class OdemeListesiActivity : AppCompatActivity() {
    ...
    lateinit var txtToplamOdeme:TextView
    var toplamOdeme=0.0
    @SuppressLint("MissingInflatedId")
    @RequiresApi(Build.VERSION_CODES.O)
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_odeme_listesi)
        onBaslat()
        overridePendingTransition(R.anim.anim_slide_in_right, R.anim.anim_slide_in_left)
        ivBack.setOnClickListener(View.OnClickListener { finish() })
        progressBar = findViewById(R.id.progressBar)
        Toast.makeText(this,getString(R.string.yapilanodemelerlisteleniyor), Toast.LENGTH_LONG).show()
        ...
        btnGoster.setOnClickListener {odemeTarihGetir()}
    }
    ...
    private fun odemeTarihGetir() {
        toplamOdeme=0.0
        Toast.makeText(this,getString(R.string.secilentarihegoreodemelisteleme), Toast.LENGTH_LONG).show()
        startLoadingAnimation()
        ID.clear()
        EVRAK_NO.clear()
        TIPI.clear()
            ...
            { response ->
                try {
                    ...
                    for (i in 0 until json.length()) {
                        ...
                        toplamOdeme+=item.getString("TUTAR").toString().toFloat().toDouble()
                    ...
                    var yuzler = 1000
                    var ondalik = 18 % 100
                    var dizi = toplamOdeme.toString().split(".")
                    ...
                    txtToplamOdeme.setText(getString(R.string.toplam_odeme)+": "+sonucBul)
                } catch (e: Exception) {
                ...
                recyclerView_odeme.layoutManager = LinearLayoutManager(this)
