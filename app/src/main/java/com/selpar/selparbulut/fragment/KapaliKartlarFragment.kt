...
class KapaliKartlarFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view=inflater.inflate(R.layout.fragment_kapali_kartlar, container, false)
        progressBar = view.findViewById(R.id.progressBar)
        Toast.makeText(requireContext(),getString(R.string.kapalikartlarlisteleniyor),Toast.LENGTH_LONG).show()
    ...
    private fun kartArananGetir(aranan: String)  {
        Toast.makeText(requireContext(),getString(R.string.kapalikartlardaaramayapiliyor),Toast.LENGTH_LONG).show()
        startLoadingAnimation()
        KabulId.clear()
        FirmaKodu.clear()
        FirmaAdi.clear()
    ...
    private fun KapaliKarlarGetir() {
        ...
        val urlek ="&username="+username+"&uid="+uid+"&baslangic_Tarihi="+today+"&bitis_Tarihi="+today+"&kabuldurumu=KAPALI"
