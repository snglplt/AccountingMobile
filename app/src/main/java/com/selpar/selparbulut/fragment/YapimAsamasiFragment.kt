...
class YapimAsamasiFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        yapimAsamasiResimGetir()
        return view
    }
    private fun yapimAsamasiResimGetir() {
        val urlek = "&username=" + username + "&uid=" + uid + "&KabulId=" + id
        //"&baslangic_Tarihi=2023-06-01&bitis_Tarihi=2023-06-30"
        var url = Consts.KabulKartiResimlerYapimAsamasi + urlek
        val deneme_url =
                ...
                try {
                    ...
                    for (i in 0 until json.length()) {
                        ...
                        if(Resimtest!="null") {
                            ...
                            Toast.makeText(requireContext(),getString(R.string.aracaaityapimasamasiresmibulunmamakta),Toast.LENGTH_LONG).show()
                        val alert= Alert()
                        alert.showAlert(requireContext(),getString(R.string.uyari),getString(R.string.aracaaityapimasamasiresmibulunmamakta))
