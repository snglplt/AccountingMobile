...
class OlayYeriResimleriFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_olay_yeri_resimleri, container, false)
                ...
                try {
                    ...
                    for (i in 0 until json.length()) {
                        ...
                        if(Resimtest!="null") {
                            ...
                            Toast.makeText(requireContext(),getString(R.string.aracaaitolayyeriresmibulunmamakta),Toast.LENGTH_LONG).show()
                        val alert= Alert()
                        alert.showAlert(requireContext(),getString(R.string.uyari),getString(R.string.aracaaitolayyeriresmibulunmamakta))
