...
class OncekiOnarimlarFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_onceki_onarimlar, container, false)
        Toast.makeText(
            requireContext(),
            getString(R.string.oncekionarimlardaaramayapabilirsin),
            Toast.LENGTH_LONG
        ).show()
